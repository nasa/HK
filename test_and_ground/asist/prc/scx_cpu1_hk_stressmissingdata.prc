PROC scx_cpu1_hk_stressmissingdata
;*******************************************************************************
...
write ";*********************************************************************"
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket1 DataSize=32 DataPattern=0x12345678
;;ut_tlmupdate SCX_CPU1_TST_HK_CMDPC
size = 32
pktLen = (12 + size) - 7
rawCmd = %hex(InputPacket1,4) & "C000" & %hex(pktLen,4) & "000000000000"
;; Add the data
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket1, DataBytePattern, Pkt1, MissingYes, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket2, DataBytePattern, Pkt2, MissingYes, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket3, DataBytePattern, Pkt3, MissingYes, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket4, DataBytePattern, Pkt4, MissingYes, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket5, DataBytePattern, Pkt5, MissingYes, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket6, DataBytePattern, Pkt6, MissingYes, 0)

write ";*********************************************************************"
write ";  Step 4.0: Send all the data."
write ";*********************************************************************"
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket1 DataSize=32 DataPattern=0x11112222
;;wait 2
size = 32
pktLen = (12 + size) - 7
rawCmd = %hex(InputPacket1,4) & "C000" & %hex(pktLen,4) & "000000000000"
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket2 DataSize=32 DataPattern=0xaaaabbbb
;;wait 2
rawCmd = %hex(InputPacket2,4) & "C000" & %hex(pktLen,4) & "000000000000"
;; Add the data
for i = 1 to size/4 do
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hk_stressmissingdata                      "
write ";*********************************************************************"
ENDPROC
