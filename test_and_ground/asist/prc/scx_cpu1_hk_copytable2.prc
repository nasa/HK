...
;       05/11/21        Walt Moleski    Updated the HK offsets to accomodate
...
s create_tbl_file_from_cvt(hostCPU,appid,"Copy Table 2","hk_cpy_tbl.tbl",HKCopyTblName,"SCX_CPU1_HK_CopyTable[1].InputMid",endmnemonic)


write ";*********************************************************************"
write ";  End procedure scx_cpu1_hk_copytable2  "
write ";*********************************************************************"
ENDPROC
