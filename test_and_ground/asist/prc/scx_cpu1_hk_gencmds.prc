...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_NOOP_CMD_EID, "INFO", 1

ut_sendcmd "SCX_CPU1_HK_NOOP"
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1000;1003) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_NOOP_CMD_EID, "."
  ut_setrequirements HK_1000, "F"
  ut_setrequirements HK_1003, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_CMD_LEN_ERR_EID, "ERROR", 1

local errcnt = SCX_CPU1_HK_CMDEC + 1
...
ut_tlmwait SCX_CPU1_HK_CMDEC, {errcnt}
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_CMD_LEN_ERR_EID, "."
  ut_setrequirements HK_1004, "F"
endif
...
if (SCX_CPU1_HK_CMDPC = 0) then
  ;; Send a NOOP command
  /SCX_CPU1_HK_NOOP
  wait 5
endif

if (SCX_CPU1_HK_CMDEC = 0) then
  /raw {rawcmd}
  wait 5
endif

if (SCX_CPU1_HK_CMBPKTSSENT = 0) or (SCX_CPU1_HK_MISSDATACTR = 0) then
  ...
  ;;  /SCX_CPU1_TST_HK_SENDOUTMSG MsgId=outmsgid Pad= 0
...
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_RESET_CNTRS_CMD_EID, "DEBUG", 1

/SCX_CPU1_HK_RESETCTRS
wait 5

ut_tlmwait SCX_CPU1_HK_CMDPC, 0
if (UT_TW_Status = UT_Success) then
...
ut_tlmwait SCX_CPU1_HK_CMDEC, 0
if (UT_TW_Status = UT_Success) then
...
write ";*********************************************************************"
ut_tlmwait SCX_CPU1_HK_CMBPKTSSENT, 0
if (UT_TW_Status = UT_Success) then
...
ut_tlmwait SCX_CPU1_HK_MISSDATACTR, 0
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1001) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_RESET_CNTRS_CMD_EID, "."
  ut_setrequirements HK_1001, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_MSG_LEN_ERR_EID, "ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (1002;1004) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements HK_1002, "P"
  ut_setrequirements HK_1004, "P"
else
  write "<!> Failed (1002;1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_MSG_LEN_ERR_EID, "."
  ut_setrequirements HK_1002, "F"
  ut_setrequirements HK_1004, "F"
endif
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_MSG_LEN_ERR_EID, "."
  ut_setrequirements HK_1004, "F"
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_CC_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_CC_ERR_EID, "."
  ut_setrequirements HK_1004, "F"
endif
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_hk_gencmds                                  "
write ";*********************************************************************"
ENDPROC
