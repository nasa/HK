...
s create_tbl_file_from_cvt(hostCPU,appid,"Copy Table 4","hk_cpy_tbl.tbl",HKCopyTblName,"SCX_CPU1_HK_CopyTable[1].InputMid",endmnemonic)


write ";*********************************************************************"
write ";  End procedure scx_cpu1_hk_copytable4                               "
write ";*********************************************************************"
ENDPROC
