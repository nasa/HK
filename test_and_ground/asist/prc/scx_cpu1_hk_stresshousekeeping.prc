PROC scx_cpu1_hk_stresshousekeeping
;*******************************************************************************
...
;                                       and to call scx_cpu1_hk_start_apps
...
page SCX_CPU1_HK_COMBINED_PKT4
page SCX_CPU1_HK_COMBINED_PKT5
page SCX_CPU1_HK_COMBINED_PKT6

write ";*********************************************************************"
write ";  Step 1.2: Creating the copy table used for testing and upload it"
write ";********************************************************************"
s SCX_CPU1_hk_copytable3
...
if (SCX_CPU1_HK_CMDPC = 0) AND (SCX_CPU1_HK_CMDEC = 0) AND ;;
   (SCX_CPU1_HK_CMBPKTSSENT = 0) AND (SCX_CPU1_HK_MISSDATACTR = 0) THEN
  ...
  write "  CMDPC                    = ",SCX_CPU1_HK_CMDPC
  write "  CMDEC                    = ",SCX_CPU1_HK_CMDEC
  write "  Combined Packets Sent    = ",SCX_CPU1_HK_CMBPKTSSENT
  write "  Missing Data Counter     = ",SCX_CPU1_HK_MISSDATACTR
  write "  Memory Pool Handle       = ",SCX_CPU1_HK_MEMPOOLHNDL
...
/SCX_CPU1_EVS_EnaAppEVTType Application=HKAppName DEBUG
...
wait 10
/SCX_CPU1_TO_ADDPACKET Stream=OutputPacket5 Pkt_Size=x'0' Priority=x'0' Reliability=x'1' Buflimit=x'4'
wait 10
/SCX_CPU1_TO_ADDPACKET Stream=OutputPacket6 Pkt_Size=x'0' Priority=x'0' Reliability=x'1' Buflimit=x'4'
wait 10

local size, pktLen

;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket1 DataSize=32 DataPattern=0x01234567
;;wait 2
size = 32
pktLen = (12 + size) - 7
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket2 DataSize=32 DataPattern=0x89abcdef
;;wait 2
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket1, DataBytePattern, Pkt1, NoChecks, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket2, DataBytePattern, Pkt2, NoChecks, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket3, DataBytePattern, Pkt3, NoChecks, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket4, DataBytePattern, Pkt4, NoChecks, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket5, DataBytePattern, Pkt5, NoChecks, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket6, DataBytePattern, Pkt6, NoChecks, 0)
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{HKAppName},HK_UNKNOWN_COMBINED_PACKET_EID,"INFO",1

;;/SCX_CPU1_TST_HK_SENDOUTMSG MsgId=InputPacket1 Pad=0
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (2001) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements HK_2001, "P"
else
  write "<!> Failed (2001) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HK_UNKNOWN_COMBINED_PACKET_EID, "."
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=OuputPacket1 DataSize=4 DataPattern=0x11111111
size = 4
pktLen = (12 + size) - 7
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",3
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=HKCopyTblName
...
/SCX_CPU1_TBL_ACTIVATE ATABLENAME=HKCopyTblName
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket15 DataSize=16 DataPattern=0x12345678
;;wait 2
size = 16
pktLen = (12 + size) - 7
...
ut_setupevents "SCX", "CPU1", {HKAppName}, HK_ACCESSING_PAST_PACKET_END_EID, "ERROR", 1

;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket19 DataSize=4 DataPattern=0x19191919
;;wait 2
size = 4
pktLen = (12 + size) - 7
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write"<*> Passed (2001.5) - Event message", SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements HK_20015, "P"
else
  write "<!> Failed (2001.5) - Event message ", SCX_CPU1_evs_eventid," received.  Expected Event message ", HK_ACCESSING_PAST_PACKET_END_EID, "."
  ut_setrequirements HK_20015, "F"
endif

;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket20 DataSize=4 DataPattern=0x20202020
;;wait 2
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket1, DataBytePattern, Pkt1, TblUpdate, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket2, DataBytePattern, Pkt2, TstLenTstTbl, 0)
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket4, DataBytePattern, Pkt4, TstLenTstTbl, 0)
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket3 DataSize=4 DataPattern=0x23456789
;;wait 2
size = 4
pktLen = (12 + size) - 7
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket4 DataSize=8 DataPattern=0x3456789a
;;wait 2
size = 8
pktLen = (12 + size) - 7
rawCmd = %hex(InputPacket4,4) & "C000" & %hex(pktLen,4) & "000000000000"
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket5 DataSize=4 DataPattern=0x456789ab
;;wait 2
size = 4
pktLen = (12 + size) - 7
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket6 DataSize=3 DataPattern=0x56789a00
;;wait 2
size = 3
pktLen = (12 + size) - 7
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket8 DataSize=8 DataPattern=0x789abcde
;;wait 2
...
;;/SCX_CPU1_TST_HK_SENDINMSG MsgId=InputPacket11 DataSize=4 DataPattern=0xabcdef01
;;wait 2
size = 4
pktLen = (12 + size) - 7
...
s SCX_CPU1_hk_sendoutmsg(OutputPacket2, DataBytePattern, Pkt2, TblUpdate, 0)
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hk_stresshousekeeping                       "
write ";*********************************************************************"
ENDPROC
