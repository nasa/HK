PROC scx_cpu1_hk_basichousekeeping
;*******************************************************************************
...
;	05/11/21	Walt Moleski	Added 4 bytes of data to each raw cmd
...
size = 4
pktLen = (16 + size) - 7
rawCmd = %hex(InputPacket20,4) & "C000" & %hex(pktLen,4) & "0000000000000000000020202020"
write ">> RawCmd = '",rawCmd,"'"
/RAW {rawCmd}
wait 1
...
write ";*********************************************************************"
write ";  End procedure scx_cpu1_hk_basichousekeeping                        "
write ";*********************************************************************"
ENDPROC
