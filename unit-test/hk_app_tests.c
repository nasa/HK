...
void Test_HK_AppMain_SingleRunLoop(void)
{
    ...
    /* Arrange */
    CFE_SB_MsgId_t forced_MsgID                    = 1; /* invalid message ID */
    ...
    /* Setting an invalid message ID and message size to avoid
    ...
    call_count_CFE_SB_ReceiveBuffer = UT_GetStubCount(CFE_SB_ReceiveBuffer);
...
void Test_HK_AppInit_Success(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_INIT_EID);
...
void Test_HK_AppInit_SBCreatePipeFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CR_PIPE_ERR_EID);
...
void Test_HK_AppInit_SBSubscribe1Fail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_SUB_CMB_ERR_EID);
...
void Test_HK_AppInit_SBSubscribe2Fail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_SUB_REQ_ERR_EID);
...
void Test_HK_AppInit_SBSubscribe3Fail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_SUB_CMD_ERR_EID);
...
void Test_HK_AppInit_PoolCreateFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CR_POOL_ERR_EID);
...
void Test_HK_TableInit_RegisterCpyTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CPTBL_REG_ERR_EID);
...
void Test_HK_TableInit_RegisterRtTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_RTTBL_REG_ERR_EID);
...
void Test_HK_TableInit_LoadCpyTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CPTBL_LD_ERR_EID);
...
void Test_HK_TableInit_ManageCpyTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CPTBL_MNG_ERR_EID);
...
void Test_HK_TableInit_ManageRtTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_RTTBL_MNG_ERR_EID);
...
void Test_HK_TableInit_GetAddrCpyTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CPTBL_GADR_ERR_EID);
...
void Test_HK_TableInit_GetAddrRtTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_RTTBL_GADR_ERR_EID);
...
void Test_HK_TableInit_ProcessNewCpyTblFail(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_NEWCPYTBL_INIT_FAILED_EID);
...
void Test_HK_AppPipe_CombinedPktLengthOk(void)
{
    ...
    CFE_SB_MsgId_t  forced_MsgID = HK_SEND_COMBINED_PKT_MID;
...
void Test_HK_AppPipe_CombinedPktBadLength(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_MSG_LEN_ERR_EID);
...
void Test_HK_AppPipe_HkReqLengthOk(void)
{
    ...
    CFE_SB_MsgId_t  forced_MsgID = HK_SEND_HK_MID;
    CFE_SB_Buffer_t DummyBuf;
...
void Test_HK_AppPipe_NoopCmd(void)
{
    /* Arrange */
    size_t            forced_Size    = sizeof(HK_NoArgCmd_t);
    CFE_SB_MsgId_t    forced_MsgID   = HK_CMD_MID;
...
void Test_HK_AppPipe_UnknownCmd(void)
{
    ...
    char  ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    snprintf(ExpectedEventString, CFE_MISSION_EVS_MAX_MESSAGE_LENGTH,
             "Cmd Msg with Invalid command code Rcvd -- ID = 0x%%08X, CC = %%d");
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_CC_ERR_EID);
...
void Test_HK_AppPipe_ProcessIncoming(void)
{
    ...
    size_t          forced_Size  = sizeof(HK_NoArgCmd_t);
    CFE_SB_MsgId_t  forced_MsgID = 47; /* invalid/unrecognized MID */
    CFE_SB_Buffer_t DummyBuf;
...
void Test_HK_SendCombinedHKCmd(void)
{
    /* Arrange */
    CFE_SB_Buffer_t DummyBuf;
    uint8           call_count_CFE_SB_GetUserData;
    uint8           call_count_HK_SendCombinedHkPacket;
...
void Test_HK_HousekeepingCmd(void)
{
    ...
    HK_AppData.MemPoolHandle       = (CFE_ES_MemHandle_t)CFE_RESOURCEID_WRAP(5);
...
void Test_HK_NoopCmd_LengthOk(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_NOOP_CMD_EID);
...
void Test_HK_ResetCtrsCmd_LengthOk(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, HK_RESET_CNTRS_CMD_EID);
...
void UtTest_Setup(void)
{
    ...
    /* Test functions for HK_AppMain */
    UtTest_Add(Test_HK_AppMain_Success, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppMain_Success");
    UtTest_Add(Test_HK_AppMain_InitFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppMain_InitFail");
    UtTest_Add(Test_HK_AppMain_SingleRunLoop, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppMain_SingleRunLoop");
    UtTest_Add(Test_HK_AppMain_RcvBufFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppMain_RcvBufFail");

    UtTest_Add(Test_HK_AppMain_RcvBufTimeout, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppMain_RcvBufTimeout");
    UtTest_Add(Test_HK_AppMain_RcvBufTimeoutCheckFail, HK_UT_Setup, HK_UT_TearDown,
               "Test_HK_AppMain_RcvBufTimeoutCheckFail");

    /* Test functions for HK_AppInit */
    UtTest_Add(Test_HK_AppInit_Success, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_Success");
    UtTest_Add(Test_HK_AppInit_EVSRegFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_EVSRegFail");
    UtTest_Add(Test_HK_AppInit_SBCreatePipeFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_SBCreatePipeFail");
    UtTest_Add(Test_HK_AppInit_SBSubscribe1Fail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_SBSubscribe1Fail");
    UtTest_Add(Test_HK_AppInit_SBSubscribe2Fail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_SBSubscribe2Fail");
    UtTest_Add(Test_HK_AppInit_SBSubscribe3Fail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_SBSubscribe3Fail");
    UtTest_Add(Test_HK_AppInit_PoolCreateFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_PoolCreateFail");
    UtTest_Add(Test_HK_AppInit_TblInitFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_TblInitFail");
    UtTest_Add(Test_HK_AppInit_SendEventFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppInit_SendEventFail");

    /* Test functions for HK_TableInit */
    UtTest_Add(Test_HK_TableInit_Success, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_Success");
    UtTest_Add(Test_HK_TableInit_RegisterCpyTblFail, HK_UT_Setup, HK_UT_TearDown,
               "Test_HK_TableInit_RegisterCpyTblFail");
    UtTest_Add(Test_HK_TableInit_RegisterRtTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_RegisterRtTblFail");
    UtTest_Add(Test_HK_TableInit_LoadCpyTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_LoadCpyTblFail");
    UtTest_Add(Test_HK_TableInit_ManageCpyTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_ManageCpyTblFail");
    UtTest_Add(Test_HK_TableInit_ManageRtTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_ManageRtTblFail");
    UtTest_Add(Test_HK_TableInit_GetAddrCpyTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_GetAddrCpyTblFail");
    UtTest_Add(Test_HK_TableInit_GetAddrRtTblFail, HK_UT_Setup, HK_UT_TearDown, "Test_HK_TableInit_GetAddrRtTblFail");
    UtTest_Add(Test_HK_TableInit_ProcessNewCpyTblFail, HK_UT_Setup, HK_UT_TearDown,
               "Test_HK_TableInit_ProcessNewCpyTblFail");

    /* Test functions for HK_AppPipe */
    UtTest_Add(Test_HK_AppPipe_CombinedPktLengthOk, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_CombinedPktLengthOk");
    UtTest_Add(Test_HK_AppPipe_CombinedPktBadLength, HK_UT_Setup, HK_UT_TearDown,
               "Test_HK_AppPipe_CombinedPktBadLength");
    UtTest_Add(Test_HK_AppPipe_HkReqLengthOk, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_HkReqLengthOk");
    UtTest_Add(Test_HK_AppPipe_HkReqBadLength, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_HkReqBadLength");
    UtTest_Add(Test_HK_AppPipe_HkReqBadTblStatus, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_HkReqBadTblStatus");
    UtTest_Add(Test_HK_AppPipe_NoopCmd, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_NoopCmd");
    UtTest_Add(Test_HK_AppPipe_ResetCmd, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_ResetCmd");
    UtTest_Add(Test_HK_AppPipe_UnknownCmd, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_UnknownCmd");
    UtTest_Add(Test_HK_AppPipe_ProcessIncoming, HK_UT_Setup, HK_UT_TearDown, "Test_HK_AppPipe_ProcessIncoming");

    /* Test functions for HK_SendCombinedHkPacket */
    UtTest_Add(Test_HK_SendCombinedHKCmd, HK_UT_Setup, HK_UT_TearDown, "Test_HK_SendCombinedHKCmd");

    /* Test functions for HK_HousekeepingCmd */
    UtTest_Add(Test_HK_HousekeepingCmd, HK_UT_Setup, HK_UT_TearDown, "Test_HK_HousekeepingCmd");

    /* Test functions for HK_NoopCmd */
    UtTest_Add(Test_HK_NoopCmd_LengthOk, HK_UT_Setup, HK_UT_TearDown, "Test_HK_NoopCmd_LengthOk");
    UtTest_Add(Test_HK_NoopCmd_LengthError, HK_UT_Setup, HK_UT_TearDown, "Test_HK_NoopCmd_LengthError");

    /* Test functions for HK_ResetCtrsCmd */
    UtTest_Add(Test_HK_ResetCtrsCmd_LengthOk, HK_UT_Setup, HK_UT_TearDown, "Test_HK_ResetCtrsCmd_LengthOk");
    UtTest_Add(Test_HK_ResetCtrsCmd_LengthError, HK_UT_Setup, HK_UT_TearDown, "Test_HK_ResetCtrsCmd_LengthError");

    /* Test functions for HK_ResetHkData */
    UtTest_Add(Test_HK_ResetHkData, HK_UT_Setup, HK_UT_TearDown, "Test_HK_ResetHkData");
}
