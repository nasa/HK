...
/** \brief <tt> 'Cmd Msg with Invalid command code Rcvd -- ID = 0x\%08X, CC = \%d' </tt>
**  \event <tt> 'Cmd Msg with Invalid command code Rcvd -- ID = 0x\%08X, CC = \%d' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'HK table definition exceeds packet length. MID:0x\%08X, Length:\%d, Count:\%d' </tt>
**  \event <tt> 'HK table definition exceeds packet length. MID:0x\%08X, Length:\%d, Count:\%d' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'HK Processing New Table:SB_Subscribe for Mid 0x\%08X returned 0x\%04X' </tt>
**  \event <tt> 'HK Processing New Table:SB_Subscribe for Mid 0x\%08X returned 0x\%04X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Combined HK Packet 0x\%08X is not found in current HK Copy Table' </tt>
**  \event <tt> 'Combined HK Packet 0x\%08X is not found in current HK Copy Table' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Combined Packet 0x\%08X missing data from Input Pkt 0x\%08X' </tt>
**  \event <tt> 'Combined Packet 0x\%08X missing data from Input Pkt 0x\%08X' </tt>
**
**  \par Type: DEBUG
**
**  \par Cause:
...
/** \brief <tt> 'Error Subscribing to HK Snd Cmb Pkt, MID=0x\%08X, RC=0x\%08X' </tt>
**  \event <tt> 'Error Subscribing to HK Snd Cmb Pkt, MID=0x\%08X, RC=0x\%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Error Subscribing to HK Request, MID=0x%08X, RC=0x\%08X' </tt>
**  \event <tt> 'Error Subscribing to HK Request, MID=0x%08X, RC=0x\%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Error Subscribing to HK Gnd Cmds, MID=0x%08X, RC=0x\%08X' </tt>
**  \event <tt> 'Error Subscribing to HK Gnd Cmds, MID=0x%08X, RC=0x\%08X' </tt>
**
**  \par Type: ERROR
**
**  \par Cause:
